...
-- 2. Create whatsapp_order_messages table for real-time dispatch tracking & deduplication
...
-- 3. Indexes for fast deduplication checks and real-time lookup
...
-- 4. Enable Row Level Security (RLS) & allow public/anon access matching the store schema
...
-- 5. Realtime publication for whatsapp_order_messages
